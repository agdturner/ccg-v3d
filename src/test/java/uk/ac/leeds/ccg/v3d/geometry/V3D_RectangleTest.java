...
//                + " )\n"
//                + "))";
        String expResult = "V3D_Rectangle(p=V3D_Plane(oom=-3, offset=V3D_Vector(dx=0, dy=0, dz=0),\n"
    ...
    public void testIsIntersectedBy_V3D_Line() {
        ...
        //Test 2
        assertFalse(instance.isIntersectedBy(new V3D_Line(pN1N1N1, pN1N1P1), oom, rm));
    }
    ...
    public void testIsIntersectedBy_V3D_LineSegment_boolean() {
        ...
        assertTrue(instance.isIntersectedBy(l, oom, rm));
        //Test 2
        assertFalse(instance.isIntersectedBy(new V3D_Line(pP0N1P1, pP0N1N1), oom, rm));
    }
...
//        assertEquals(expResult, result);
    ...
    public void testEquals_V3D_Rectangle_int_RoundingMode() {
        ...
        V3D_Rectangle instance = new V3D_Rectangle(pP0P0P0, pP0P1P0, pP1P1P0, pP1P0P0);
        boolean expResult = true;
        boolean result = instance.equals(r, oom, rm);
        assertEquals(expResult, result);
        // Test 2
        instance = new V3D_Rectangle(pP0P1P0, pP1P1P0, pP1P0P0, pP0P0P0);
        result = instance.equals(r, oom, rm);
        assertEquals(expResult, result);
        // Test 3
