...
public class V3D_LineTest extends V3D_Test {
    ...
    public void testIsIntersects_V3D_Point_int_RoundingMode() {
        ...
        // Test 2
        pt = new V3D_Point(env, P0_1E2, P0_1E2, P0_1E2);
        assertTrue(instance.intersects(pt, oom, rm));
        // Test 3 works as the rounding puts pt on the line.
        pt = new V3D_Point(env, P0_1E12, P0_1E12, P0_1E12);
        assertTrue(instance.intersects(pt, oom, rm));
        // Test 4 works as the rounding puts pt on the line.
        pt = new V3D_Point(env, N0_1E12, N0_1E12, N0_1E12);
        assertTrue(instance.intersects(pt, oom, rm));
    ...
    public void testGetIntersection_V3D_Line_int_RoundingMode() {
        ...
        l = new V3D_Line(pN1N1N1, pP1P1P1, oom, rm);
        instance = new V3D_Line(new V3D_Point(env, P3, P1, P1),
                new V3D_Point(env, P1, P3, P3), oom, rm);
        expResult = pP2P2P2;
        result = instance.getIntersect(l, oom, rm);
        assertTrue(((V3D_Point) expResult).equals((V3D_Point) result, oom, rm));
        // Test 5
        l = new V3D_Line(pN1N1P0, pP1P1P0, oom, rm);
        instance = new V3D_Line(new V3D_Point(env, P3, P3, P0),
                new V3D_Point(env, P3, P3, N1), oom, rm);
        expResult = new V3D_Point(env, P3, P3, P0);
        result = instance.getIntersect(l, oom, rm);
        assertTrue(((V3D_Point) expResult).equals((V3D_Point) result, oom, rm));
        // Test 6
        l = new V3D_Line(pN1N1N1, pP1P1P1, oom, rm);
        ...
        instance = new V3D_Line(env, new V3D_Vector(N3, N3, N3),
                new V3D_Vector(N4, N4, N4));
        result = instance.getIntersect(l, oom, rm);
        ...
        assertTrue(((V3D_Point) expResult).equals((V3D_Point) result, oom, rm));
        // Test 16
        l = new V3D_Line(pP0N1P1, new V3D_Point(env, P2, P1, P3), oom, rm);
        expResult = pP1P0P2;
        instance = new V3D_Line(env, new V3D_Vector(P1, P0, P2),
        ...
        assertTrue(((V3D_Point) expResult).equals((V3D_Point) result, oom, rm));
        // Test 22
        l = new V3D_Line(pP0P1N1, new V3D_Point(env, P2, P3, P1), oom, rm);
        expResult = pP1P2P0;
        ...
        l = new V3D_Line(pP0P0P0, pP1P1P1, oom, rm);
        instance = new V3D_Line(pP0P0P0, pP1P1P1, oom, rm);
        ...
        assertTrue(((V3D_Point) expResult).equals((V3D_Point) result, oom, rm));
        // Test 29
        l = new V3D_Line(new V3D_Point(env, N1.add(P0_1),
                N1.add(P0_1), N1),
    ...
    public void testGetDistance_V3D_Point_int_RoundingMode() {
        ...
        instance = new V3D_Line(new V3D_Point(env, N2, N4, P5), 
                new V3D_Point(env, N1, N2, P3), oom, rm);
    ...
    public void testGetDistance_V3D_Line_int() {
        ...
        //l = new V3D_Line(env, new V3D_Vector(P2, P6, N9), new V3D_Vector(P1, N2, P5));
        ...
        //instance = new V3D_Line(env, new V3D_Vector(N1, N2, P3), new V3D_Vector(P3, N4, N2));
        ...
        oom = -4;
        instance = new V3D_Line(pP1N1P0, pP2P0P0, oom, rm);
    ...
    public void testRotate() {
        ...
        V3D_Environment env = new V3D_Environment(oom, rm);
        theta = Pi.divide(2);
        instance = new V3D_Line(env, new V3D_Vector(0, 0, 0), new V3D_Vector(5, 0, 0));
        //expResult = new V3D_Line(new V3D_Vector(0, 0, 0), new V3D_Vector(0, 0, 5), oom, rm);
        expResult = new V3D_Line(env, new V3D_Vector(0, 0, 0), new V3D_Vector(0, 0, -5));
        result = instance.rotate(axis, axis.l.v, bd, theta, oom, rm);
        assertTrue(expResult.equals(result, oom, rm));
        // Test 4
        theta = Pi;
        instance = new V3D_Line(env, new V3D_Vector(3, 2, 0), new V3D_Vector(5, 0, 0));
        expResult = new V3D_Line(env, new V3D_Vector(-3, 2, 0), new V3D_Vector(-5, 0, 0));
        result = instance.rotate(axis, axis.l.v, bd, theta, oom, rm);
        assertTrue(expResult.equals(result, oom, rm));
    }
