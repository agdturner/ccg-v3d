...
public class V3D_AABBX_d implements Serializable {
     ...
     * V3D_Plane_d(getll(), V3D_Vector.I);
     */
        ...
        switch (len) {
            ...
            default -> {
                ...
                for (int i = 1; i < points.length; i++) {
                    ymin = double.min(ymin, points[i].getY());
                    ymax = double.max(ymax, points[i].getY());
    ...
    public boolean equals(V3D_AABBX_d e) {
        return  x.compareTo(e.x) == 0
                ...
                && getZMin().compareTo(e.getZMin()) == 0
                && getZMax().compareTo(e.getZMax()) == 0;
    }
    ...
    public V3D_Plane_d getXPl() {
        if (xpl == null) {
            xpl = new V3D_Plane_d(getll(), V3D_Vector.I);
        }
        return xpl;
    }
...
//        yMin = yMin.add(v.getDY());
    ...
    public V3D_AABBX_d union(V3D_AABBX_d e, ) {
        if (this.contains(e)) {
            ...
            return new V3D_AABBX_d(env, ,
                    x,
                    double.min(e.getYMin(), getYMin()),
                    double.max(e.getYMax(), getYMax()),
    ...
    public boolean isBeyond(V3D_AABBX_d e) {
        return getYMax().compareTo(e.getYMin()) == -1
    ...
    public boolean contains(V3D_AABBX_d e) {
        return getYMax().compareTo(e.getYMax()) != -1
    ...
    public boolean contains(V3D_Point_d p) {
        return getYMax().compareTo(p.getY()) != -1
