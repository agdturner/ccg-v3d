 ...
 * finite geometries in the V3D_AABB_d instance. A general rectangle cannot be
...
public class V3D_AABBX_d extends V3D_AABB2D_d {
    ...
    /**
     * @return {@link #x} with {@link #offset}.dx added.
     */
    public double getX() {
        return x + offset.dx;
    }
    ...
    public V3D_Point_d getll() {
        if (ll == null) {
            ll = new V3D_Point_d(env, getX(), getYMin(), getZMin());
        }
        return ll;
    }
    ...
    public V3D_Point_d getlu() {
        if (lu == null) {
            lu = new V3D_Point_d(env, getX(), getYMin(), getZMax());
        }
        return lu;
    }
    ...
    public V3D_Point_d getuu() {
        if (uu == null) {
            uu = new V3D_Point_d(env, getX(), getYMax(), getZMax());
        }
        return uu;
    }
    ...
    public V3D_Point_d getul() {
        if (ul == null) {
            ul = new V3D_Point_d(env, getX(), getYMax(), getZMin());
        }
        return ul;
    }
    ...
    public V3D_FiniteGeometry_d getLeft() {
        if (left == null) {
            ...
            double zmax = getZMax();
            if (zmin == zmax) {
                left = new V3D_Point_d(env, getX(), ymin, zmax);
            } else {
                left = new V3D_LineSegment_d(
                        new V3D_Point_d(env, getX(), ymin, zmin),
                        new V3D_Point_d(env, getX(), ymin, zmax));
            }
        }
        return left;
    }
    ...
    public V3D_Plane_d getLeftPlane() {
        if (lpl == null) {
            lpl = new V3D_Plane_d(new V3D_Point_d(env, getX(), getYMin(),
                    getZMin()), V3D_Vector_d.NJ);
        }
        return lpl;
    }
    ...
    public V3D_FiniteGeometry_d getRight() {
        if (right == null) {
            ...
            double zmax = getZMax();
            if (zmin == zmax) {
                right = new V3D_Point_d(env, getX(), ymax, zmax);
            } else {
                right = new V3D_LineSegment_d(
                        new V3D_Point_d(env, getX(), ymax, zmin),
                        new V3D_Point_d(env, getX(), ymax, zmax));
            }
        }
        return right;
    }
    ...
    public V3D_Plane_d getRightPlane() {
        if (rpl == null) {
            rpl = new V3D_Plane_d(new V3D_Point_d(env, getX(), getYMax(),
                    getZMax()), V3D_Vector_d.J);
        }
        return rpl;
    }
    ...
    public V3D_FiniteGeometry_d getTop() {
        if (top == null) {
            ...
            double zmax = getZMax();
            if (ymin == ymax) {
                top = new V3D_Point_d(env, tx, ymin, zmax);
            } else {
                top = new V3D_LineSegment_d(
                        new V3D_Point_d(env, tx, ymin, zmax),
                        new V3D_Point_d(env, tx, ymax, zmax));
            }
        }
        return top;
    }
    ...
    public V3D_Plane_d getTopPlane() {
        if (tpl == null) {
            tpl = new V3D_Plane_d(new V3D_Point_d(env, getX(), getYMax(),
                    getZMax()), V3D_Vector_d.K);
        }
        return tpl;
    }
    ...
    public V3D_FiniteGeometry_d getBottom() {
        if (bottom == null) {
            ...
            double zmin = getZMin();
            if (ymin == ymax) {
                bottom = new V3D_Point_d(env, tx, ymin, zmin);
            } else {
                bottom = new V3D_LineSegment_d(
                        new V3D_Point_d(env, tx, ymin, zmin),
                        new V3D_Point_d(env, tx, ymax, zmin));
            }
        }
        return bottom;
    }
    ...
    public V3D_Plane_d getBottomPlane() {
        if (bpl == null) {
            bpl = new V3D_Plane_d(new V3D_Point_d(env, getX(), getYMin(),
                    getZMin()), V3D_Vector_d.NK);
        }
        return bpl;
    }
     ...
     * @param y1 getP().getY()
     * @param y2 getQ().getY()
     * @param y3 left.getP().getY()
     * @param y4 left.getQ().getY()
     * @param z1 p.getZ()
     * @param z2 q.getZ()
    ...
    public V3D_Geometry_d getIntersect(V3D_Line_d l0, V3D_Line_d l, double den,
        ...
        if (V3D_AABB_d.intersects(l0, l, den, epsilon)) {
            ...
            return new V3D_Point_d(env, getX(), numy / den, numz / den);
        }
        return null;
    }
}
