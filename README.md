...
[Spherical](https://en.wikipedia.org/wiki/Spherical_coordinate_system) and [ecliptic](https://en.wikipedia.org/wiki/Ecliptic_coordinate_system) coordinate systems are beoming more commonly used. These represent positions relative to the estimation of a centroid and the axis of [Earth's rotation](https://en.wikipedia.org/wiki/Earth%27s_rotation).
