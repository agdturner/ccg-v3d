...
## Getting Started
It is advised that you load this as a [Maven project](https://maven.apache.org/) in your favourite IDE. This should make it easy to download the dependencies and run the tests. The tests provide some indication of how you might used the library for example to determine the intersection of two geometries. Another entry point is to use the [ccg-r3d](https://github.com/agdturner/ccg-r3d) - a rendering library that can visualise [V3D_Geometry](https://github.com/agdturner/ccg-v3d/blob/master/src/main/java/uk/ac/leeds/ccg/v3d/geometry/V3D_Geometry) objects.
